...
CREATE TABLE api_users (
    user_id             NUMBER DEFAULT api_users_seq.NEXTVAL NOT NULL,
...
CREATE TABLE api (
    api_id      NUMBER DEFAULT api_seq.NEXTVAL NOT NULL,
...
CREATE TABLE api_access (
    access_id        NUMBER DEFAULT api_access_seq.NEXTVAL NOT NULL,
    ...
    CONSTRAINT api_access_user_fk FOREIGN KEY ( user_id )
        REFERENCES api_users ( user_id ),
    CONSTRAINT api_access_api_fk FOREIGN KEY ( api_id )
...
CREATE TABLE pricing_model (
    model_id      NUMBER DEFAULT pricing_model_seq.NEXTVAL NOT NULL,
...
CREATE TABLE requests (
    request_id    NUMBER DEFAULT requests_seq.NEXTVAL NOT NULL,
    req_timestamp DATE DEFAULT sysdate NOT NULL,
    response_time NUMBER(5, 2),
    status        VARCHAR2(25) NOT NULL,
    request_body  VARCHAR2(255) NOT NULL,
    response_body VARCHAR2(255) NOT NULL,
    user_id       NUMBER NOT NULL,
    access_id     NUMBER NOT NULL,
    CONSTRAINT requests_pk PRIMARY KEY ( request_id ),
    CONSTRAINT requests_user_fk FOREIGN KEY ( user_id )
        REFERENCES api_users ( user_id ),
    CONSTRAINT requests_access_fk FOREIGN KEY ( access_id )
...
CREATE TABLE usage_tracking (
    tracking_id    NUMBER DEFAULT usage_tracking_seq.NEXTVAL NOT NULL,
    request_count  INTEGER NOT NULL,
    last_updated   DATE DEFAULT sysdate NOT NULL,
    limit_exceeded NUMBER(1) NOT NULL,
    api_id         NUMBER NOT NULL,
    user_id        NUMBER NOT NULL,
    CONSTRAINT usage_tracking_pk PRIMARY KEY ( tracking_id ),
    CONSTRAINT usage_tracking_users_fk FOREIGN KEY ( user_id )
        REFERENCES api_users ( user_id ),
    CONSTRAINT usage_tracking_api_fk FOREIGN KEY ( api_id )
        REFERENCES api ( api_id )
);
...
CREATE TABLE subscription (
    subscription_id   NUMBER DEFAULT subscription_seq.NEXTVAL NOT NULL,
    start_date        DATE DEFAULT sysdate NOT NULL,
    end_date          DATE,
    status            VARCHAR2(25) NOT NULL,
    discount          NUMBER(5, 3) DEFAULT 0.00 NOT NULL,
    user_id           NUMBER NOT NULL,
    pricing_model_id  NUMBER NOT NULL,
    ...
    CONSTRAINT subscription_users_fk FOREIGN KEY ( user_id )
        REFERENCES api_users ( user_id ),
...
CREATE TABLE billing (
    billing_id      NUMBER DEFAULT billing_seq.NEXTVAL NOT NULL,
