...
---Grant Basic connect permission
    EXECUTE IMMEDIATE 'GRANT CREATE SESSION TO API_MANAGER';
     DBMS_OUTPUT.PUT_LINE('GRANTED CREATE SESSION TO USER API_MANAGER');
    
    
---Grant Read Access to all the tables

    EXECUTE IMMEDIATE 'GRANT SELECT ON USERS TO API_MANAGER';
    ...
    EXECUTE IMMEDIATE 'GRANT SELECT ON BILLING TO API_MANAGER';
    ...
    DBMS_OUTPUT.PUT_LINE('GRANTED READ ACCESS TO USER API_MANAGER');
...
---Grant Full access to API table (can add, modify, deprecate APIs)
    ...
    EXECUTE IMMEDIATE 'GRANT INSERT, UPDATE, DELETE ON API TO API_Manager';
     DBMS_OUTPUT.PUT_LINE('GRANTED FULL ACCESS TO USER API_MANAGER FOR API TABLE ONLY');
...
-- Full access to API_ACCESS table (can grant/revoke user access to APIs)
    ...
    EXECUTE IMMEDIATE 'GRANT INSERT, UPDATE, DELETE ON API_ACCESS TO API_Manager';
      DBMS_OUTPUT.PUT_LINE('GRANTED FULL ACCESS TO USER API_MANAGER FOR API_ACCESS TABLE ONLY');
    
-- Grant quota on tablespace (necessary for INSERT operations)
   EXECUTE IMMEDIATE' ALTER USER API_Manager QUOTA UNLIMITED ON USERS';
   DBMS_OUTPUT.PUT_LINE('UNLIMITED MEMORY ALLOCATION PROVIDED TO USER API_MANAGER');
